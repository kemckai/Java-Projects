 ...
 * @param i 
    */
   public static void putln(int i, int j, int k, int l, int m, int n, int o, int p, int q, int r, int s, int t) {
      out.println();
      out.flush();
      if (out.checkError())
         outputError("Error while writing output.");
   ...
   private static void outputError(String message) {  // Report an error on output.
    ...
    static void readStandardInput(String icecreamdat) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    static void readStream(String icecreamdat) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
